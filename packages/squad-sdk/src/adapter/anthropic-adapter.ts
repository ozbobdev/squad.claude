...
export class AnthropicSessionAdapter implements SquadSession {
  ...
  constructor(apiKey: string, model: string, systemPrompt?: string, tools?: SquadTool[]) {
    this.anthropic = new Anthropic({ apiKey });
    this.sessionId = crypto.randomUUID();
    this.model = model;
    this.systemPrompt = systemPrompt ?? 'You are a helpful software engineering assistant.';
